...
const UserSignUpPageWithTranslationWithApiProgress = withTranslation()(UserSignUpPageWithApiProgressForAuthRequest);

export default connect()(UserSignUpPageWithTranslationWithApiProgress);